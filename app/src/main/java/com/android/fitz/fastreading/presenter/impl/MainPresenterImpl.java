...
import com.android.fitz.fastreading.presenter.IMainPresenter;
...
public class MainPresenterImpl extends BasePresenter<IEmptyView> implements IMainPresenter {

    private RetrofitService mService;
    private Context mContext;

    @Inject
    public MainPresenterImpl(RetrofitService service, @ContextLife("Application") Context context){
    ...
    public void checkCode() {
        String mac =  AppUtils.getIMEI(mContext);
        String verCode = PreferencesUtils.getString(mContext, Preferences.GRANT_CODE_KEY);
        mView.showProgress();
        mService.checkCode("checkvercode", mac, verCode)
                ...
                .subscribe(new BaseSubscriber<CommonResult, IEmptyView>(mView){
