 ...
 */
public class ExtendTrainSettingAdapter extends BaseQuickAdapter<SelectItem, BaseViewHolder> {

    public ExtendTrainSettingAdapter(int layoutResId, List<SelectItem> data) {
