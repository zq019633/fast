...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(AnimaPictDao.class);
        registerDaoClass(ArticleDao.class);
        registerDaoClass(MenuViewDao.class);
