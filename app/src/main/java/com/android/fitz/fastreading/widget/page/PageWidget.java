...
import com.android.fitz.fastreading.widget.page.animation.AnimationProvider;
import com.android.fitz.fastreading.widget.page.animation.CoverAnimation;
import com.android.fitz.fastreading.widget.page.animation.NoneAnimation;
import com.android.fitz.fastreading.widget.page.animation.SimulationAnimation;
import com.android.fitz.fastreading.widget.page.animation.SlideAnimation;
...
public class PageWidget extends View {
    ...
    private int mScreenWidth = 1200; // 翻书控件宽
    private int mScreenHeight = 600; // 翻书控件高
    ...
    private int mBgColor = 0x00CEC29C;
...
//        mScreenHeight = metric.heightPixels;
    ...
    public void setBgColor(int color){
        //mBgColor = color;
        mBgColor = mContext.getResources().getColor(R.color.white);
    }
