...
public class ExtendTrainMoveGame3Activity extends BaseActivity {
    ...
    protected int getContentViewLayoutID() {
        return R.layout.activity_extend_train_move_game3;
    }
    ...
    private void initData(){
        ...
        //final String[] arrRoute = {"1", "7", "13", "19", "25"};
        //final String[] arrRoute = {"1", "2", "3", "4", "5", "6"};
        ...
        // 查找正确答案index
        int index = 0;
        for(AnimaPict pict1 : list){
            if(pict1.getId().equals(pict.getId())){
                break;
            }
            index ++;
        }
        for(int i = 0; i<count - imgCount; i++) {
            int position = CommonUtils.getRandom(0, list.size() - 1, index);
        ...
        Flowable.interval(1000/speed, TimeUnit.MILLISECONDS)
                ...
                .subscribe(new Subscriber<Long>() {
                    ...
                    public void onNext(Long aLong) {
                        ...
                        Glide.with(ExtendTrainMoveGame3Activity.this)
                        ...
                        if(aLong == mList.size() - 1){
                            new Handler().postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    bundle.putParcelable(Constant.COMMON_KEY, answerEntity);
                                    readyGoThenKill(ExtendTrainGameResultActivity.class, bundle);
                                }
                            }, 1500);
                        }
                    }
